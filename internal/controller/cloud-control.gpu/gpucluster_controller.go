...
// +kubebuilder:rbac:groups=cloud-control.gpu.kyma-project.io,resources=gpuclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloud-control.gpu.kyma-project.io,resources=gpuclusters/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cloud-control.gpu.kyma-project.io,resources=gpuclusters/finalizers,verbs=update
...
func (r *GpuClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudcontrolgpuv1beta1.GpuCluster{}).
		Named("cloud-control.gpu-gpucluster").
		Complete(r)
}
